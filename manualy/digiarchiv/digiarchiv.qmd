...
## Využití dat a citace

Data dostupná v Digitálním archivu AMČR jsou zveřejňována v souladu s politikou otevřeného přístupu k datům a se souhlasem držitelů autorských práv. 
Využití dat podléhá (pokud není explicitně uvedeno jinak) licenci **CC-BY-NC 4.0** (Creative Commons Uveďte původ Neužívejte komerčně 4.0), viz sekce [Licence](../../zakladni-info/licence.qmd). 
Data je proto možné využít pouze s uvedením autora a pouze pro nekomerční použití.

Zdrojem podkladových map je [Geoportál ČÚZK](https://geoportal.cuzk.cz/){.external} a [OpenStreetMap](https://www.openstreetmap.org/){.external}. 
...
- v textu: 	
    ...
    (...) text (AMČR, M-201400460A);
    
- v seznamu zdrojů jednotlivě: 
...
- nebo v seznamu zdrojů souhrnně:
...
Vzhledem k tomu, že Digitální archiv AMČR, ale i další nástroje patřící do rámce infrastruktury [Archeologický informační systém ČR (AIS CR)](https://aiscr.cz/){.external}, poskytují data převážně v otevřeném režimu (Open Access), nemáme možnost sledovat využití těchto dat, ani to, jaké výstupy na jejich základě vznikají. 
Jelikož jsme však tyto informace povinni ze zákona vykazovat, chtěli bychom Vás, uživatele Digitálního archivu AMČR, požádat o součinnost při vykazování vědeckých výstupů, při jejichž vzniku byla využita data z Digitálního archivu AMČR či dalších součástí AIS CR.
