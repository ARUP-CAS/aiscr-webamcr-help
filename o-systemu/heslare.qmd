...
Obsažená hesla vycházejí z hesel užívaných v ADČ [@kuna2006], SAS [@volfik2009] a formulářích [ZAA](pojmy.qmd#zpráva-o-archeologické-akci-zaa). 
...
Aplikace obecně preferuje uzavřené hesláře, jejichž doplnění je možné pouze v důvodných případech po konzultaci se [správcem systému](pojmy.qmd#správce-systému). 
