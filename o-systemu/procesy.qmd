...
Pro označení fáze zpracování záznamů slouží tzv. **procesní stavy**, které jsou přidělovány všem záznamům v základních datových třídách ([Projekty](pojmy.qmd#projekty), [Akce](pojmy.qmd#akce), [Lokality](pojmy.qmd#lokality), [Dokumenty](pojmy.qmd#dokumenty), [Bibliografie](pojmy.qmd#externí-zdroje-bibliografie), [PIAN](pojmy.qmd#pian)).
