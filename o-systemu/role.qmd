...
Rozšířená uživatelská práva lze získat na základě registrace (role **B** – **Badatel**), vyšší oprávnění získá pracovník některé z [organizací oprávněných k provádění archeologických výzkumů](pojmy.qmd#oprávněná-archeologická-organizace) (**C** – **Archeolog**).
