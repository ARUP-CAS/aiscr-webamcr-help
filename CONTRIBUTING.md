...
4. Projít standardním code review procesem — změny v `.agents/` vyžadují **lidský review**
...
v `.agents/prompts/review_codebase.md`. Typy sezení (general-review, content-accuracy,
