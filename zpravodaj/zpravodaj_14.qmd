...
Bez jeho digitální dostupnosti a viditelnosti by totiž jen obtížně naplňovalo svůj potenciál a nacházelo širší podporu.

Web AIS CR dostupný na [https://www.aiscr.cz/](https://www.aiscr.cz/){.external} nově obsahuje také blog *Novinky z AIS CR*. 
...
Najdete zde často kladené otázky z řad veřejnosti i archeologické obce, relevantní odkazy na užitečné dokumenty, pomůcky a nástroje (např. manuál pro focení, měřítka aj.) i vzorové dokumenty ke stažení.
Oba weby jsou dostupné také v anglické verzi.

> Budeme rádi, když nové weby vyzkoušíte a věříme, že zde naleznete užitečný obsah a budete se sem rádi vracet!
...
> *Pro lepší pochopení co se dokumenty a ostatními daty děje po odeslání v AMČR Vám přinášíme stručný popis následných kontrol, které provádějí naši archiváři a archivářky.*
...
Doposud byla licence přednastavena dle licenční smlouvy mezi AIS CR a oprávněnou organizací, která dokument nahrála, viz [Mapa OAO](https://oao.aiscr.cz/){.external}, kde je u každé organizce uvedeno, pod jakou licencí své dokumenty v AMČR zveřejňuje.
Ostatní dokumenty a dokumenty z archivů Archeologických ústavů pak byly zveřejňovány pod licencí [CC BY-NC 4.0 Int.](https://creativecommons.org/licenses/by-nc/4.0/deed.cs){.external}.
...
> O otevřených licencích, licencování dat apod. se můžete více dozvědět na webu k [Open Science](https://openscience.cz/){.external} spravovaným *Národní technickou knihovnou*, viz [https://openscience.cz/cs/open-science/komponenty/open-licencing/](https://openscience.cz/cs/open-science/komponenty/open-licencing/){.external} nebo webu [Open Science](https://openscience.lib.cas.cz/){.external} provozovaným *Knihovnou Akademie věd ČR*, viz [https://openscience.lib.cas.cz/open_access/verejne-licence/](https://openscience.lib.cas.cz/open_access/verejne-licence/){.external}.