...
>
> přinášíme Vám zpravodaj AMČR č. 12, který je spjat zejména s nasazením nové *minor* verze AMČR, ve které implementujeme (nejen) přidělování persistentních identifikátorů DOI, IGSN a dalších. Dále zpravodaj přináší informace o chybových hláškách, které Vám AMČR může vracet, ale i jiné novinky z [Archeologického informačního systému České republiky (AIS CR)](https://www.aiscr.cz/){.external}.
>
> Váš *tým* AIS CR...
...
Obdobně je pak všem **nálezům v AMČR-PAS** a **lokalitám** v momentě archivace přidělen identifikátor [**IGSN** (*International Generic Sample Number*)](https://ev.igsn.org/){.external}, což je specifický identifikátor pro fyzické entity odvozený z DOI. 
...
Toto potvrzení dostalo novou, přehlednější podobu a jeho obsah byl doplněn o poučení o zákonných povinností a možnostech oznamovatele souvisejících s realizací archeologického výzkumu. 
