...
Modul letecké snímky lze prohlížet v [Digitálním Archivu AMČR](https://digiarchiv.aiscr.cz/results?kategorie_dokumentu=lfoto&entity=dokument).
...
Pro MADB je v rámci projektu *Integrovaný informační systém archeologických pramenů Prahy* implementováno speciální webové rozhraní, které umožňuje provázání údajů MADB s další evidencí, zejména pak s fondy [Národního památkového ústavu](https://npu.cz/). 
Rozhraní je dostupné na webu [http://www.praha-archeologicka.cz/](http://www.praha-archeologicka.cz/) a bylo uvedeno do provozu v roce 2017.
