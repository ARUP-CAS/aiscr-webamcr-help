...
## Odkazy na další služby AIS CR

[Archeologická mapa České republiky (AMČR)](https://amcr-info.aiscr.cz/){.external} 
je sočástí [Archeologického informačního systému České republiky (AIS CR)](https://aiscr.cz/){.external}.
...
- Stránky **AIS CR** s odkazy na další služby a součásti systému najdete zde: [https://aiscr.cz/](https://aiscr.cz/){.external}.
...
<!-- - Na [úvodní stránce](index.qmd) najdete [základní informace](zakladni-info/zakladni-info.qmd) o celém systému, informace o [licencích](zakladni-info/licence.qmd), nápovědu k [uživatelským účtům](zakladni-info/ucty.qmd) a stručný souhrn [historie](zakladni-info/historie.qmd). -->
<!-- - V sekci [O systému](o-systemu/architektura.qmd) je rámcově popsán používaný datový model a struktura systému. -->
<!-- - Následují manuály pro jednotlivé součásti AMČR -- [webovou aplikaci](manualy/manualy.qmd), [digitální archiv](manualy/digiarchiv/digiarchiv.qmd) a [API](manualy/api/api.qmd). -->
