...
Optimalizace PDF do archviního formátu PDF/A-2b je prováděna pomocí Adobe Acrobat s využitím funkce "Kontrola před výstupem". Přesná specifikace a export nastavení jsou dostupné v [tomto archivu {{< bi file-earmark-arrow-down >}}](docs/AMCR_PDF_A2b_nastaveni.zip).
