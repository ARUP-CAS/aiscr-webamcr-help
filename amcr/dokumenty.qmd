...
Zde je možné prohlížet a editovat již existující záznamy. Přidávat zcela nové záznamy Dokumentů je možné pouze skrze moduly Projekty, Akce a Lokality.
...
![](figs/dok05.png){width="60%" fig-align="center"}

 
### Zápis nového dokumentu

Při kliknutí na tlačítko `+` v tabulce `Dokumenty` v modulech `Akce`, `Projekty` nebo `Lokality` je třeba vybrat z rolovací nabídky možnost `Přidat dokument`. Aplikace se tím přepne do editačního prostředí modulu `Dokumenty`.

![](figs/dok06.png){width="72%" fig-align="center"}

![](figs/dok07.png){width="72%" fig-align="center"}

![](figs/dok08.png){width="72%" fig-align="center"}
