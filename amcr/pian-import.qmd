...
- [ ] Soubor obsahující geometrii/geometrie jako podklad pro vytvoření PIAN ve formátu SHP. 
- [ ] Podporované souřadnicové systémy jsou **WGS 84** (EPSG: 4326) a **S-JTSK/Krovak East North** (EPSG: 5514).
