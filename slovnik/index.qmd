...
Stává se to zejména při retrospektivním zpracování starších archeologických výzkumů, u neplánovaných výzkumů (např. při nepředvídaných nálezech) nebo při aplikaci některých nedestruktivních terénních metod.
...
Správce lze kontaktovat přes emailovou adresu [{{<  bi envelope-at size=0.8em >}} info@amapa.cz](mailto:info@amapa.cz) nebo na adresách uvedených v [Kontaktech](/about).
